...
- **v0.95.0+** (Phase 7+ 抽象推演 #8+): Kernel-first 战略第二阶段 — Teacher/Parent Dashboard 应用层落地 (Kernel SDK 已 100% production-ready, v0.95+ 接收 first-party plugin 直接挂载教师/家长 Dashboard)
