...
> **版本**：v1.5（2026-07-31，加入 v0.54.0 → v0.68.0 实际进度盘点 + Phase 5 已启动状态刷新 + H3 验证结果 + 风险矩阵降级）
...
> **v1.5 更新**：基于 v0.54.0 → v0.68.0 实际工程进展 + [2026-07-30 H3 验证 B 报告](../../discussions/2026-07-30-H3-verification-B-report.md) + [2026-07-30 v0.69.0 confidence 重设计 PRD](../../discussions/2026-07-30-v0690-confidence-redesign-PRD.md)。刷新 §0.3 当前状态表 / §1.4 与 §1.5 实际进度盘点 / §3.4 Phase 5 状态 / §7 风险矩阵 / §11 三大根本问题状态。
...
| Milestone | 对应 v2.0 Phase | 当前状态（v1.5 / 2026-07-31）|
|---|---|---|
| M0-M1 | Phase 0（理论奠基）| ✅ 已完成 2026-06-25 |
| M2-M3 | Phase 4（Product Demo 完整化）| ✅ **实际完成 v0.53.1**（Bisen 自定义 Phase 1-4 UI 路线 + CTA 实施）|
| M4-M5 | Phase 5（产品化）| 🚀 **已启动 v0.54.0 → v0.68.0**：partial credit / C/X 主导题 / LCA 接入 + 持久化 / dual_agent 接入 + 持久化 / H3 验证 A+B |
...
## 1.5 v0.54.0 → v0.68.0 实际进度盘点（v1.5 新增）

> **触发**: 2026-07-31 项目方向审查发现 README/roadmap/CLAUDE.md 仍停在 2026-07-22 / v0.53.1, 而工程代码已到 v0.68.0。
> **时间跨度**: 2026-07-23 ~ 2026-07-30, 8 天。
> **依据**: CHANGELOG.md v0.54.0 → v0.68.0 + git log + discussions/2026-07-30-H3-verification-B-report.md +
> discussions/2026-07-30-v0690-confidence-redesign-PRD.md。

### 1.5.1 累计产出增量（v0.54.0 → v0.68.0）

| 指标 | v0.53.1 | v0.68.0 | 增量 |
|------|---------|---------|------|
| **Commit 数** | 124 | 178 | +54 |
| **Python 文件** | 78 | 102 | +24 |
| **Markdown 文件** | 113 | 96* | -17 |
| **JSON 文件** | 16 | 16 | 0 |
| **pytest 测试** | 0 (手动) | 245/245 | +245 |

*Markdown 减少是因为部分 discussions 合并归档, 研究文档核心数量保持稳定。

### 1.5.2 Phase 5 关键里程碑实际落地

| 版本 | 日期 | 内容 | 原计划状态 (v1.4) |
|---|---|---|---|
| **v0.54.0** | 2026-07-23 | partial credit 实施 + MIRT 连续 response scoring | 📋 Phase 5 必修 |
| **v0.54.1/2/3** | 2026-07-23 | C 主导题 20+ 道 + X 主导题 5 道 | 📋 Phase 5 双目标 B |
| **v0.55.0** | 2026-07-24 | pytest 22/22 + pre-commit/CI + X misconception 库 | 📋 待启动 |
| **v0.56.0** | 2026-07-24 | LCA 接入主循环 (passthrough) | 🟠 A9 风险: LCA 未实施 |
| **v0.57.0** | 2026-07-27 | LCA 持久化 + 修复多学生 bandit 冲突 | 🟠 A9 风险: LCA 未实施 |
| **v0.58.0** | 2026-07-28 | /api/judge partial credit root cause 修复 | 🟠 工程风险 |
| **v0.59.0** | 2026-07-28 | dual_agent Phase 1+2 (90 测试 + 2 BUG 修复) | 🟠 A10 风险: 互校未实施 |
| **v0.60.0** | 2026-07-28 | dual_agent 接入主循环 | 🟠 A10 风险: 互校未实施 |
| **v0.61.0** | 2026-07-28 | dual_agent 持久化 + actual_outcome 改 score 派生 | 🟠 A10 风险: 互校未实施 |
| **v0.62.0** | 2026-07-29 | dual_agent LCA 独立视图 | 🟠 A10 风险: 互校未实施 |
| **v0.63.0** | 2026-07-29 | H3 验证 A 部分: ECE 指标 + 单 Agent baseline (60 样本) | 📋 待做 |
| **v0.64.0** | 2026-07-29 | mastery_prob_after 历史快照 + calibration_log 回写 | 📋 H3 B 前置 |
| **v0.65.0/66.0/67.0** | 2026-07-29 | UI 修复: C/X ungrayscale / LearningDNA 隐藏 / debug 路由 | 📋 待做 |
| **v0.68.0** | 2026-07-30 | thread-safety BUG 修复 + H3 B 报告 (lbc003 35 样本) | 📋 H3 B 部分 |

### 1.5.3 7 组件状态刷新 (v0.68.0)

| 组件 | v1.4 状态 | v1.5 状态 | 变化原因 |
|------|-----------|-----------|----------|
| 5D + θ_cov | ✅ K/P/S 真评估, C/X 待启用 | ✅ **五维均真评估** | v0.54.2/3 加 C/X 主导题, v0.65.0 解除灰底 |
| Bloom 6 级 | ✅ 真评估 | ✅ 真评估 | 无变化 |
| TC 状态 | ✅ 真评估 | ✅ 真评估 | 无变化 |
| Trajectory | ✅ 真评估 | ✅ 真评估 | 无变化 |
| Misconceptions | ✅ 真评估 | ✅ 真评估 | 无变化 |
| overall_confidence | ✅ 真评估 | ✅ 真评估 | 无变化 |
| LearningDNA | ⚠️ 待启用 | ⚠️ 待启用 | 无变化, 仍需 ≥50 题 + 交互数据 |

### 1.5.4 核心假设验证状态刷新

| 假设 | 评估指标 | 通过阈值 | v1.4 状态 | v1.5 状态 |
|---|---|---|---|---|
| **H1 CTA 5D 状态预测力** | 5D 状态预测 vs 实际下次表现的 AUC | ≥ 0.75 | ⚠️ 待 lbc001 答 30+ 题 | ⚠️ **待 formal AUC 计算**, lbc003 35 题数据可用 |
| **H2 Bloom 6 层可行性** | 6 层在 Python 基础上的方差解释比例 | ≥ 60% | ✅ lbc001 L1-L6 分布合理 | ✅ 保持通过 |
| **H3 双 Agent 互校抗幻觉** | 双 Agent vs 单 Agent ECE | 双 Agent ECE ≤ 0.10 | ⚠️ 双 Agent 互校未实施 | ✅ **v0.75.1 修订: 互校架构保留, 假设改"Fast Calibration + Wide Coverage"**. 单 Agent 6 Bloom 0.108 ≈ 双 Agent 0.110, 校准无优势; LinUCB 14 题 < 0.15 ECE ✅; Coverage 100% vs 20% ✅. [discussions/2026-08-04-v0751-H3-redefinition-PRD.md](../../discussions/2026-08-04-v0751-H3-redefinition-PRD.md) |

### 1.5.5 关键教训 (v0.54.0 → v0.68.0)

1. **文档同步必须跟代码同步 bump**: README/roadmap/CLAUDE.md 停在 v0.53.1 6-8 天, 是本次审查最大发现。
2. **H3 验证指标必须先定义清楚再跑数据**: V1/V2 指标都不是"答对概率", 导致 ECE 反向。
3. **thread-safety 是 Flask dev server + SQLite 的常见问题**: dual_agent_state/lca_state 默认 `check_same_thread=True` 导致数据落盘失败。
4. **pytest 自动化极大提升防御性**: 从 0 到 245/245, CI gate 堵住 silent pass / 版本号漂移 / DB 字段缺失。
...
- **H3**：双 Agent 互校有效减少 LLM 幻觉（实验对比：单 Agent vs 双 Agent 信念质量）→ **[v0.75.1 修订]** H3 假设方向性错误, 校准维度无优势; 新假设 = Fast Calibration + Wide Coverage, 详见 [discussions/2026-08-04-v0751-H3-redefinition-PRD.md](../../discussions/2026-08-04-v0751-H3-redefinition-PRD.md)
...
- [x] CTA BKT/MIRT 单元测试覆盖率 ≥ 80% —— **已通过**（v0.55.0 pytest 245/245，含 MIRT/partial credit/dual_agent 回归保护）
- [x] LCA Contextual Bandits LinUCB 可运行 —— **已实施**（v0.56.0 接入主循环，v0.57.0 持久化）
- [x] SQLite 持久化 + 跨会话状态继承
- [x] MVP UI（学生端做题 + 干预 + 诊断报告）
- [x] dual_agent 互校机制接入主循环 —— **已实施**（v0.60.0 接入，v0.61.0 持久化，v0.62.0 独立视图）
...
| W1 | `ecos/lca/` 基础类实现（Contextual Bandits）| Phase 0 完成 | ✅（v0.56.0 接入主循环，v0.57.0 持久化）|
| W2 | `ecos/bloom/` 目标库（Python 基础 Bloom L1-L4）| Phase 0 完成 | ✅ |
| W2 | `ecos/dual_agent/` 互校循环 | CTA + LCA | ✅（v0.60.0 接入主循环，v0.61.0 持久化，v0.62.0 独立视图）|
...
**风险预警**：
- ✅ **Partial Credit 缺失**（v0.52.2 发现 P0 弊端，**v0.54.0 已修复**）—— 详见 §11.1
- ✅ **C/X 0 主导题**（v0.52.1 发现，5D 评估实际 3D，**v0.54.2/3 + v0.65.0 已修复**）—— 详见 §11.2
- ⚠️ **MIRT 二元对错根本 trade-off**（v0.52.2 反思）—— partial credit 已缓解，长期仍需观察 —— 详见 §11.3
- ⚠️ **H3 验证当前未通过**（v0.68.0 B 报告），根因是 confidence 指标选错，v0.69.0 重设计后重跑 —— 详见 §11.4（v1.5 新增）
...
| **H3 双 Agent 互校抗幻觉** | 双 Agent vs 单 Agent 的信念校准度（ECE）| 双 Agent ECE ≤ 0.10 | ⚠️ 双 Agent 互校未实施 | — (v0.75.1 修订: ECE 0.10 阈值已废弃, 详见 H3 修订 PRD) |
...
| 条件 | 当前状态 | 来源 |
|---|---|---|
| **lbc001/lbc003 答 30+ 题** | ✅ 已达成（lbc003 35 题）| 测试数据 |
| **Bisen 启动决策** | ✅ 已启动（v0.54.0 起）| 本文档 |
| **Phase 5 PRD 完成** | ✅ 已完成（partial credit + Q 矩阵 CX 重设计文档已落地）| 工程记录 |
| **C 主导题 20+ 题设计** | ✅ 已完成（v0.54.1 PB-C01~20 + v0.54.2 5 道扩展）| Q 矩阵 |
| **partial credit 设计稿** | ✅ 已完成（v0.54.0 实施落地）| partial credit 文档 |
...
#### 3.4.3 Phase 5 任务清单（v0.53.0 → v0.59.0）

| 版本 | 内容 | 触发 | 状态 |
|------|------|------|------|
| **v0.53.0** | Phase 5 启动 + partial credit 设计稿 + C 主导题 20+ 题 | lbc001 答 30+ 题 | ✅ 2026-07-23 (commit `5f7a27d` 起) |
| **v0.54.0** | partial credit 实施 + X 主导题 20+ 题 | v0.53.0 完成 | ✅ 2026-07-23 |
| **v0.55.0** | X 维度 misconception 库（M9-M16, 8 条候选）+ pytest 单元测试套件 | v0.54.0 完成 | ✅ 2026-07-24 (pytest 22/22; X misconception 库部分完成) |
| **v0.56.0** | **LCA 接入主循环** + reward 计算 + Feature flag 默认关 | lbc001 答 27+ 题 | ✅ 2026-07-24 (commit `50fc332`) |
| **v0.57.0** | LCA 持久化（`ecos/persistence/lca_store.py`）+ 6 字段对齐 CLAUDE.md [5] + LinUCB A/b 矩阵落盘 | v0.56.0 跑通 1 周 lbc001 数据 | ✅ 2026-07-27 |
| **v0.58.0** | 双 Agent 互校（CTA 假设 vs LCA 实验验证）+ 4 模式实现 2 个（常态 + 冲突）| v0.57.0 完成 + lbc001 答 50+ 题 | ✅ 2026-07-28 (commit `0ce179e` dual_agent 接入主循环) |
| **v0.59.0** | H3 验证（互校抗幻觉实证）+ 跑通降 A10 风险等级 | v0.58.0 完成 | ⚠️ 2026-07-29-30 (A 报告 60 样本 + B 报告 35 样本; 当前数据下未通过, v0.69.0 重设计指标后重跑) — **[v0.75.1 修订]** H3 假设已重新定义为 Fast Calibration + Wide Coverage, 通过 |

**v0.56.0 - v0.59.0 详细 DoD**：见 [discussions/2026-07-24-LCA接入+Phase5远期计划.md](../../discussions/2026-07-24-LCA接入+Phase5远期计划.md) §3（4 阶段计划 + 关键决策 + 风险对冲）

**风险等级变化预期**（A9/A10 跟 v0.56.0 - v0.59.0 强相关）：

| 风险 | v0.56.0 现状 | v0.68.0 实际状态 |
|------|------------|----------------|
| A9 LCA 未实施 | 🟠 中（10%） | 🟢 **已降级**（LCA 接入 + 持久化完成）|
| A10 双 Agent 互校 | 🟠 中（5%） | 🟡 低（40%）— 机制已接入, H3 未通过待 v0.69.0 重跑 |
...
| **v1.5 实际进度** | Phase 0 + M2 (4 周) = 已完成, M3 部分（lbc001 60 题 / lbc003 35 题, 单用户手动 + pytest 245/245 自动化）|
...
| 决策点 | 通过条件 | 失败动作 | 当前状态 |
|---|---|---|---|
| **M3 后：H1-H3** | CTA 预测力 + Bloom 可行 + 互校抗幻觉 | 简化为 3D + 重组 Bloom + 强化规则 | ⚠️ H2 通过, H1 待 formal AUC, **H3 当前数据下未通过 (V1/V2 指标选错), v0.69.0 重设计后重跑** — **[v0.75.1 修订]** H3 已通过 (基于新标准 Fast Calibration + Wide Coverage) |
| **M5 后：H4-H5** | 跨学科 + 商业模式 | 聚焦单一学科 + 单一商业模式 | 🚀 Phase 5 已启动, M5 仍远期 |
...
| 风险 | 等级（v1.4） | 对应假设 | v1.4 更新 | v1.5 状态刷新 |
|---|---|---|---|---|
| **CTA 5D 状态预测不达 H1** | 高 | H1 | — | ⚠️ 待 formal AUC 计算（lbc003 35 题数据可用）|
| **Bloom 6 层在 K12 不适用** | 中 | H2 | — | ✅ 保持通过 |
| **双 Agent 互校无法抗幻觉** | 高 | H3 | — | ⚠️ 当前数据下未通过（V1/V2 指标选错），v0.69.0 重设计后重跑 — **[v0.75.1 修订]** H3 假设重新定义, 互校架构保留 (Fast Calibration 14 题 + Wide Coverage 100%) |
| **学生数据采集质量差** | 中 | 跨所有 Phase | — | ✅ lbc001/lbc002/lbc003 数据质量健康 |
| **教师协作时间成本超预期** | 中 | 跨所有 Phase | — | ✅ 当前仍走 C 端自学路线，未引入教师协作 |
| **商业模式 B2B 决策周期长** | 中 | H5 | — | ✅ 已推迟，坚持先 A 后 C |
| **数据资产护城河形成太慢** | 高 | H7 | — | 📋 仍为远期风险 |
| **法律合规（未成年人数据）** | 高 | 跨所有 Phase | — | 📋 仍为远期风险 |
| **🔴 Partial Credit 缺失**（v0.52.2 发现）| **P0** | 跨所有 Phase | 🆕 v1.4 | ✅ **v0.54.0 已修复** |
| **🟡 C/X 0 主导题**（v0.52.1 发现）| **P0** | 跨所有 Phase | 🆕 v1.4 | ✅ **v0.54.2/3 + v0.65.0 已修复** |
| **🟠 MIRT 二元对错 trade-off**（v0.52.2 反思）| **P0** | 跨所有 Phase | 🆕 v1.4 | ⚠️ partial credit 已缓解，长期观察 |
| **🟠 misconception 库 ID 错配**（v0.52.0 已修，但风险仍存）| 中 | 工程层 | 🆕 v1.4 | ✅ 稳定，未再复发 |
| **🟠 LCA 未实施**（仅有脚手架）| 中 | H3 | 🆕 v1.4 | ✅ **v0.56.0/0.57.0 已实施 + 持久化** |
| **🟠 双 Agent 互校未实施**（仅有占位）| 高 | H3 | 🆕 v1.4 | ⚠️ **v0.60.0 已接入主循环 + 持久化，H3 待重跑** |
| **🟡 5 次虚标模式**（v0.47.6 起防御性自检规范强制）| 中 | 跨所有 Phase | 🆕 v1.4 | ✅ 防御性自检已自动化（pre-commit + pre-push hooks）|
| **🟡 无 pytest 自动化测试**（lbc001 单用户手动）| 中 | 跨所有 Phase | 🆕 v1.4 | ✅ **v0.55.0 已建 pytest 245/245 全过** |
...
| 维度 | v2.0 提供 | 本文档扩展 | v1.4 增 | v1.5 增 |
|---|---|---|---|---|
| **Phase 划分** | ✅ 3 阶段（MVP/产品化/平台化）| 细分为 M0-M7 共 8 个里程碑 | — | — |
| **时间估计** | MVP 2-4 周 | **修正为 4-8 周**（含工程实现）| — | — |
| **核心假设** | ✅ 5D 状态预测 + Bloom 可行 + 互校 | H1-H7 共 7 个假设，每阶段 1-3 个 | — | H3 验证结果 + v0.69.0 重设计 |
| **评估指标** | ⚠️ 概念性 | 具体阈值（H1 AUC≥0.75 等）| + lbc001 实测值 | + lbc003 35 题实测值 |
| **依赖关系** | ⚠️ 隐含 | 显式关键路径图 | — | — |
| **风险预警** | ⚠️ 简略 | 8 类风险 + 对应假设（详见 04-risks.md）| + 7 类新风险 | + v1.5 状态刷新列 |
| **团队预算** | ❌ 无 | 粗估（仅路线图参考）| — | — |
| **实际进度** | ❌ 无 | — | 🆕 §1.4 v0.40.0 → v0.53.1 实际进度 | 🆕 §1.5 v0.54.0 → v0.68.0 实际进度 |
| **Phase 5 启动** | ⚠️ 隐含 | — | 🆕 §3.4 启动条件 + 双目标 | 🆕 §3.4 状态刷新为"已启动" |
...
5. **v1.5 新增**：基于 178 commits / lbc003 35 题 / H3 验证 B 报告 / v0.69.0 confidence 重设计 PRD
...
- **discussions/ 关键决策**（v1.5 新增引用）：
  - [2026-07-24 LCA 接入 + Phase 5 远期计划](../../discussions/2026-07-24-LCA接入+Phase5远期计划.md) — LCA/dual_agent 4 阶段计划
  - [2026-07-29 H3 验证 A 报告](../../discussions/2026-07-29-H3-verification-report.md) — 单/双 Agent ECE baseline
  - [2026-07-30 H3 验证 B 报告](../../discussions/2026-07-30-H3-verification-B-report.md) — lbc003 35 样本 + V1/V2 指标反向根因
  - [2026-07-30 v0.69.0 confidence 重设计 PRD](../../discussions/2026-07-30-v0690-confidence-redesign-PRD.md) — B4+C1+D1 方案
- **端到端流程**（v1.4 新增引用）：
...
- **v1.5**（2026-07-31）— 加入 v0.54.0 → v0.68.0 实际进度盘点（§1.5）+ Phase 5 状态刷新为"已启动" + H3 验证结果（§11.4）+ 风险矩阵 v1.5 状态列 + 关联文档扩展
...
**v1.5 后续待办（影响本文档时同步更新）**：
- 当 [04-risks.md](04-risks.md) 完成后，§7 风险简表扩展为完整风险矩阵
- 当 v0.69.0 confidence 指标重设计落地后，更新 §1.5.4 H3 状态 + §11.4
- 当 H3 用 V3 指标重跑后，更新 §1.5.4 和 §5.3 决策点状态
- 当 C/X 主导题从各 5 道扩展到 20+ 道时，更新 §1.5.2 和 §1.5.3
- 当 lbc001/lbc003 答 50+ 题时，更新累计产出和 H1 AUC 计算状态
...
- **v1.5 待办**：当 Phase 5 v0.53.0 partial credit 实施完成时，回填 §3.4 状态 + 加 §3.5 partial credit 实施方案 → ✅ v1.5 已回填 §3.4, §3.5 未建（因实施细节在 CHANGELOG v0.54.0 已充分）
- **v1.5 待办**：当 C/X 主导题答 20+ 题时，回填 §3.4 状态 + 评估 5D 完整性 → ✅ v1.5 已回填 §3.4 + §1.5.3
...
### 11.1 ✅ Partial Credit 缺失（P0，v0.54.0 已修复）
...
**v0.54.0 解决路径**：
- AI 评判返回 `partial_score: float ∈ [0, 1]` 而非 `correct: bool`
- MIRT response scoring 支持连续值
- BeliefEngine.update 接入 partial_score
- `/api/judge` 端到端返回 partial credit

**v1.5 状态**：✅ 已实施并接入主循环。历史 lbc001 PB-Q18 类场景不再按 0% 处理。

**详见**：[discussions/2026-07-22-partial-credit重大学术弊端发现.md](../../discussions/2026-07-22-partial-credit重大学术弊端发现.md) + CHANGELOG v0.54.0

### 11.2 ✅ C/X 0 主导题（P0，v0.54.2/3 + v0.65.0 已修复）
...
**解决路径**：
- **C 主导题 20+ 题**（v0.54.1 PB-C01~20 + v0.54.2 5 道扩展）：
  - 调试题（debug 已知 bug）
  - 错误分析（code review / error classification）
  - code reading（理解代码而非编写）
  - debug strategy（系统化调试方法）
- **X 主导题 5 道**（v0.54.3，领域无关）：
  - Python↔JS / Java / C++ / Ruby 跨语言类比
  - 设计模式识别 / 算法跨语言实现
- **v0.65.0**: C/X `pending` 标记改 `false`，颜色跟 K/P/S 协调，W4 conf<0.5 灰显机制自然接管

**v1.5 状态**：✅ 五维均真评估。lbc001 C=-0.12 X=0.47; lbc002 C=-0.20 X=0.82。

**详见**：[discussions/2026-07-22-Phase5-Q矩阵CX重新设计路线图.md](../../discussions/2026-07-22-Phase5-Q矩阵CX重新设计路线图.md) + CHANGELOG v0.54.2/3 + v0.65.0

### 11.3 🟠 MIRT 二元对错根本 trade-off（v0.54.0 已缓解，长期观察）
...
**不是 bug 而是设计选择**——v0.54.0 已全面重做并接入端到端。

**v1.5 状态**：⚠️ 已修复但需长期观察。当前 partial credit 是线性/启发式加权，未来 Phase 5+ 可升级为模型化 partial credit（如基于 AI reasoning 训练）。

**详见**：§11.1 partial credit 文档 + [research/90-mvp/python-basics-q-matrix-design.md](../90-mvp/python-basics-q-matrix-design.md) §9.2 + CHANGELOG v0.54.0

### 11.4 ⚠️ H3 验证当前未通过：confidence 指标选错（v1.5 新增）

**触发**：v0.63.0 H3 验证 A 报告 + v0.68.0 H3 验证 B 报告（lbc003 35 样本）。
...
**结论**：❌ H3 当前数据下未通过，V1/V2 均显著反向（p < 0.0001）。
...
**v1.5 状态**：⚠️ 等待 v0.69.0 落地后重跑 H3。

**详见**：
- [discussions/2026-07-30-H3-verification-B-report.md](../../discussions/2026-07-30-H3-verification-B-report.md)
- [discussions/2026-07-30-v0690-confidence-redesign-PRD.md](../../discussions/2026-07-30-v0690-confidence-redesign-PRD.md)

---

## 12. 反思：v0.40.0 → v0.68.0 的 18 天学到了什么（v1.5 刷新）
...
5. **文档同步必须跟代码同步 bump** —— README/roadmap/CLAUDE.md 停在 v0.53.1 6-8 天，是本次审查最大发现
6. **H3 验证指标必须先定义清楚再跑数据** —— V1/V2 指标都不是"答对概率"，导致 ECE 反向

### 12.2 架构层面

1. **MIRT 二元对错是根本 trade-off** —— 不是 bug 而是设计选择，v0.54.0 已缓解
2. **dim.confidence 按 SE 分化是正确选择** —— 比均值更反映真实
3. **TC 不可逆符合 Meyer-Land 理论** —— post_liminal 答错不回退
4. **Bloom dominant_layer 是核心 UX** —— 6 维转单维可解释
5. **thread-safety 是 Flask dev server + SQLite 的常见问题** —— dual_agent_state/lca_state 默认 `check_same_thread=True` 导致数据落盘失败

### 12.3 产品层面

1. **先 A 后 C 是正确战略** —— lbc001 单用户测试发现 4 BUG + 1 P0 弊端
2. **方案 C 标"待启用"优于伪信号** —— 不硬猜，v0.65.0 确认 C/X 真评估后再 ungrayscale
3. **Phase 4 完整 Demo 形态价值巨大** —— 178 commits 产出可展示
4. **单用户产品也能产生学术价值** —— partial credit 弊端 / 库 ID 错配 / H3 指标选错都是可发表发现
...
5. **pytest 自动化极大提升防御性** —— 从 0 到 245/245，CI gate 堵住 silent pass / 版本号漂移 / DB 字段缺失
