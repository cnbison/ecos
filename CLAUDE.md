...
> **当前阶段（2026-08-12）**：**Phase 4（Product Demo 完整化）实际完成，Phase 5（产品化）已启动 v0.54.0 → v0.91.0**。
...
> 详见 [03-roadmap.md](./research/00-overview/03-roadmap.md) (v1.5+ 已同步) + [12-kernel-mapping-current-vs-2.0.md §8.2 v0.92.0 更新](./research/00-overview/12-kernel-mapping-current-vs-2.0.md)。
>
