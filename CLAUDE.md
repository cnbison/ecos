...
> 详见 [03-roadmap.md](./research/00-overview/03-roadmap.md) (v1.5+ 已同步) + [12-kernel-mapping-current-vs-2.0.md §8.2 v0.91.0 更新](./research/00-overview/12-kernel-mapping-current-vs-2.0.md)。
>
